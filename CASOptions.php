...
class CASOptions
{
    ...
    public function MappingFirstname()
    {
        return $this->GetConfig(CASConfig::CAS_MAPPING_FIRSTNAME);
    }

    public function MappingLastname()
    {
        return $this->GetConfig(CASConfig::CAS_MAPPING_LASTNAME);
    }

    public function MappingEmail()
    {
        return $this->GetConfig(CASConfig::CAS_MAPPING_EMAIL);
    }

    public function MappingOrganization()
    {
        return $this->GetConfig(CASConfig::CAS_MAPPING_ORGANIZATION);
    }
